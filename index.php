               ...
               <?php if (!empty($banners)): ?>
                  <?php foreach ($banners as $banner): ?>
                     <div class="swiper-slide">
                        <div class="tpslider pt-90 pb-0 grey-bg">
                           <div class="container">
                              <div class="row align-items-center">
                                 <div class="col-xxl-5 col-lg-6 col-md-6 col-12 col-sm-6">
                                    <div class="tpslider__content pt-20">
                                       <h2 class="tpslider__title mb-30"><?php echo htmlspecialchars($banner['title']); ?></h2>
                                       <p><?php echo htmlspecialchars($banner['meta_description']); ?></p>
                                       <div class="tpslider__btn">
                                          <a class="tp-btn" href="<?php echo !empty($banner['target_url']) ? htmlspecialchars($banner['target_url']) : 'shop.php'; ?>">Shop Now</a>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-xxl-7 col-lg-6 col-md-6 col-12 col-sm-6">
                                    <div class="tpslider__thumb p-relative pt-15">
                                       <img class="tpslider__thumb-img" src="<?php echo $banner['image']; ?>" alt="">
                           ...
                           <div class="row align-items-center">
                              <div class="col-xxl-5 col-lg-6 col-md-6 col-12 col-sm-6">
                                 <div class="tpslider__content pt-20">
                                    ...
                                    <div class="tpslider__btn">
                                       <a class="tp-btn" href="shop.php">Shop Now</a>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-xxl-7 col-lg-6 col-md-6 col-12 col-sm-6">
