...
class Functions
{
    ...
    public function register($firstname, $lastname, $email, $password, $confirm_password, $gender)
    {
        ...
        // $stmt = $this->db->conn->prepare("INSERT INTO users (firstname, lastname, email, password, gender) VALUES (?, ?, ?, ?, ?)");
        // $stmt->bind_param("sssss", $firstname, $lastname, $email, $hashed_password, $gender);
        $provider = "manual"; // ✅ Set provider for manual sign-ups
    ...
    public function addBillingAddress($user_id, $firstname, $lastname, $email, $phone, $country, $province, $city, $street_address, $zip_code, $landmark, $address_type)
    {
        ...
        // Insert new billing address into the database
