                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-sm-6">
                        <div class="tpfooter__widget footer-col-1 mb-50">
                            ...
                            <p>If you have any question, please <br> contact us at:
                                <a href="mailto:indianbasket@gamil.com">indianbasket@gamil.com</a>
                            </p>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="tpfooter__widget footer-col-2 mb-50">
                            <h4 class="tpfooter__widget-title">Address</h4>
                            <p>Capstone, Conestoga College
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-7 col-sm-12">
                        <div class="tpfooter__copyright">
                            <span class="tpfooter__copyright-text">Copyright © <a href="#">INDIAN BASKET</a> all rights reserved.</a>.</span>
                        </div>
                    </div>
